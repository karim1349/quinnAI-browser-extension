        ...
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
          {actions.map((action, index) => {
            if(action.subActions == undefined){
              return (
                <li>
                  <a onClick={() => executeAction(action)} class="block flex py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer">
                    {action.icon}
              ...
              return (
                <li>
                  <a id="multiLevelDropdownButton" onClick={() => openSecondDropdown(action.name, event)} class="block py-2 flex hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white justify-between pr-2 cursor-pointer">
