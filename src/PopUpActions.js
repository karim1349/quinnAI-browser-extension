            ...
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className="inline-block align-bottom bg-white text-left shadow-xl transform transition-all sm:my-8 sm:align-middle w-3/5 rounded-lg" role="dialog" aria-modal="true" aria-labelledby="modal-title">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-t-lg">
                        <div>
                            <div class="absolute right-2" onClick={() => props.setAction(0)} onMouseDown={(e) => e.preventDefault()}>
                    ...
                    <div class="flex items-center">
                            {
                                ...
                                null :
                                <div class="refreshButton" onClick={() => setLastSubAction(subAction)} onMouseDown={(e) => e.preventDefault()}>
                                    <RefreshIcon/>
                                </div>
                        ...
                        
                        {
                            ...
                            <>
                            <button id="multiLevelDropdownButton2" onClick={() => openDropdown()} onMouseDown={(e) => e.preventDefault()} data-dropdown-toggle="dropdown" class="shadow rounded-lg px-4 py-2.5 mx-2.5 w-48 text-center inline-flex items-center justify-between focus:outline-none" type="button">
                                <div class="flex items-center">
                            ...
                            <div id="dropdown2" class="z-10 hidden bg-white mx-2.5 my-2 rounded-lg shadow w-48 absolute">
                                ...
                                {props.action.subActions.map((subAction, index) => {
                                    return(
                                        <li key={index}>
                                            <a onClick={() => setSubAction(subAction) } onMouseDown={(e) => e.preventDefault()} class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{subAction.label}</a>
                                        </li>
                                    )
                                })}
                                </ul>
